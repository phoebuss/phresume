...
% uncomment the following if contact info should display
%\setprop {email} {example@gmail.com}
%\setprop {phone} {(123)456-7890}

\begin {document}
\begin {section} {Summary}
\desc {Principal Software Development Engineer in Fortinet Inc.}
...
\timeline {Principal Software Development Engineer} {04/2022} {present}
\text {Fortinet Inc., Sunnyvale, California}
\desc {Develop new features for the Next Generation Firewall (NGFW).}
\desc {Lead bringing up FortiOS on new products, including FGT30G, FGT50G.}
...
\desc {Lead hardware \& embedded system development on wearable Android device.}
\sep

\timeline {Research \& Development Engineer} {10/2013} {06/2014}
\text {Shenzhen MinDe Electronics Technology Ltd., Shenzhen, China}
\desc {Contribute to handheld barcode scanner system development.}
\end {section}
